...
public class Task2DWTests {
    ...
    public void testNthMostActiveUserGraph1() {
        Assertions.assertEquals(0, dwig1.NthMostActiveUser(1, SendOrReceive.SEND));
        Assertions.assertEquals(1, dwig1.NthMostActiveUser(2, SendOrReceive.SEND));
        Assertions.assertEquals(4, dwig1.NthMostActiveUser(3, SendOrReceive.SEND));
        Assertions.assertEquals(8, dwig1.NthMostActiveUser(4, SendOrReceive.SEND));
        Assertions.assertEquals(-1, dwig1.NthMostActiveUser(5, SendOrReceive.SEND));

        Assertions.assertEquals(0, dwig1.NthMostActiveUser(1, SendOrReceive.RECEIVE));
        Assertions.assertEquals(8, dwig1.NthMostActiveUser(2, SendOrReceive.RECEIVE));
        Assertions.assertEquals(-1, dwig1.NthMostActiveUser(3, SendOrReceive.RECEIVE));
    }

    @Test
    public void testNthMostActiveUserGraph2() {
        Assertions.assertEquals(2, dwig2.NthMostActiveUser(1, SendOrReceive.SEND));
        ...
        Assertions.assertEquals(3, dwig2.NthMostActiveUser(1, SendOrReceive.RECEIVE));
        Assertions.assertEquals(8, dwig2.NthMostActiveUser(2, SendOrReceive.RECEIVE));
